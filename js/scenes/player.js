...
class Player {
    ...
    preloadPlayer() {
        ...
        this.context.load.spritesheet('characterAttack', '../../sprites/character/B_witch_attack_projectile.png', { frameWidth: 48, frameHeight: 48 });
    }
    createPlayer() {
        ...
        this.context.key_f = this.context.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.F);
        ...
        this.context.anims.create({
            key: 'attackProj',
            frames: this.context.anims.generateFrameNumbers('characterAttackProjectile', { start: 0, end: 10 }),
            frameRate: 5
        });
        // this.context.anims.create({
        //     key:'death',
    ...
    updatePlayer() {
        ...
        if (this.context.key_e.isDown) {
            ...
            console.log(this.player.body.getOffset())
        }
        else if (this.context.key_f.isDown) {
            // Proyectil ataque
            this.player.anims.play('attackProj', true);
            this.player.setVelocityX(0);
            this.player.setVelocityY(0);
        }
